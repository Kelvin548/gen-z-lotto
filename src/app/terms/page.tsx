...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-[#0b0b0c] text-white relative overflow-x-hidden flex flex-col selection:bg-yellow-500 selection:text-black">
      ...
      {/* 3D Floating Bubbles Background Restored */}
      <FloatingBubbles />
      ...
      <main className="relative z-10 flex-1 max-w-4xl mx-auto px-6 py-12 space-y-8 w-full">
        <div>
          ...
          <p className="text-zinc-400 text-sm mt-2">Please read these terms carefully before participating in Gen Z Lotto digital draws.</p>
        </div>
        ...
        <div className="space-y-6 text-zinc-300 text-sm leading-relaxed bg-zinc-950/80 backdrop-blur-xl p-8 rounded-3xl border border-yellow-500/20 shadow-2xl">
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-yellow-400">1. Acceptance of Terms</h2>
            <p>By accessing and using Gen Z Lotto, you agree to comply with and be bound by these terms and conditions.</p>
          </section>
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-yellow-400">2. Eligibility</h2>
            <p>You must be at least 18 years of age to register an account, purchase tickets, or claim winnings on the platform.</p>
          </section>
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-yellow-400">3. Ticket Bookings & Payouts</h2>
            <p>All ticket selections are immutable once confirmed. Winnings are automatically credited to your secure platform wallet ledger.</p>
          </section>
        </div>
      </main>
